...
require.define("/keystate.js",function(require,module,exports,__dirname,__filename,process,global){var keyState = function(keysDown) {
	var instance = {
		keys: {
			'w': 87,
			'a': 65,
		...
		down: function(keyCode) {
			if (Object.values(this.keys).find(keyCode)) {
